...
namespace WindowsFormsProveedores.Logica_Prov
{
    public class ProveedoresLogica
    {
        ...
        ///<summary>
        ///Este codigo comprueba la existencia de un proveedor en el tabla
        ///</summary>
        ...
        ///<summary>
        ///Este codigo guarda un proveedor en la base de datos
        ///</summary>
        ...
        ///<summary>
        ///Este metodo permite editar el proveedor en cuestion usando la id del mismo en el sistema
        ///</summary>
        ...
        ///<summary>
        ///Este metodo permite eliminar el proveedor en cuestion usando la id del mismo en el sistema
        ///</summary>
